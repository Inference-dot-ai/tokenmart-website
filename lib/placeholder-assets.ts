...
export const PLACEHOLDER_IMAGES: string[] = [
  "/model-assets/claude-opus-4-7.png",
  "/model-assets/claude-opus-4-6.png",
  "/model-assets/claude-haiku-4-5.png",
  "/model-assets/gpt-5-4.png",
  "/model-assets/gpt-5-2.png",
  "/model-assets/gpt-5.png",
  "/model-assets/gemini-3-1-pro-preview.png",
  "/model-assets/gemini-3-flash-preview.png",
  "/model-assets/grok-4-1.png",
  "/model-assets/qwen-3-max.png",
  "/model-assets/qwen-flash.png",
  "/model-assets/seedream-5-0.png",
  "/model-assets/seedream-4-5.png",
  "/model-assets/glm-5-1.png",
  "/model-assets/glm-5v-turbo.png",
  "/model-assets/deepseek-v3-2.png",
